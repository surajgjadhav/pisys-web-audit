...
class SnapshotsOnEntityView extends Component {
  state = {
    entities: [],
    author: "",
    changedProperty: "",
  ...
  componentDidMount() {
    ...
    axios
      .get(`/audit/snapshots/entities/${this.props.entity}/${this.props.id}`)
      .then((response) => {
  ...
  submitHandler = () => {
    ...
    axios
      .put(
        `/audit/snapshots/entities/${this.props.entity}/${this.props.id}/filter`,
        filter
      )
      .then((response) => {
        const jsn = response.data;
